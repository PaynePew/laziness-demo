...
import sty from "./PlasmicCallToActionSection.module.css"; // plasmic-import: 6XRBcj5dbKAqQ0/css
...
function PlasmicCallToActionSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__tEU1)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox___7TcOw)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__luANp)}
          >
            <p.Stack
              as={"div"}
                ...
                defaultContents: (
                  <React.Fragment>
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__w4LOy)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
