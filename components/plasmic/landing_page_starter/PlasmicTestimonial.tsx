...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: kaaNaks9l5Jr0_/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__uCzgW)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__yq00O)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__v1IKv)}
        >
          <div className={classNames(projectcss.all, sty.freeBox___7Llbx)}>
            {p.renderPlasmicSlot({
