...
import sty from "./PlasmicAdmin.module.css"; // plasmic-import: GGAMZHnNF_K/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__uuMA)}>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__wcQu4)}
              >
                <Button
                  className={classNames("__wab_instance", sty.button__xn4Bz)}
